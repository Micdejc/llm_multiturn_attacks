...
This is the official repository for "[Jailbreaking LLMs Through Tense Manipulation
 in Multi-Turn Dialogues](https://doi.org/10.1007/978-3-032-07938-1_24)" by [Michael Tchuindjang](https://github.com/Micdejc), [Nathan Duran](<Insert Link Here>), [Phil Legg](https://github.com/pa-legg), and [Faiza Medjek](<Insert Link Here>). 
